...
public class ImpPluginAttribute extends PluginObject implements IPluginAttribute {
	...
	public ImpPluginAttribute() {
	}

	ImpPluginAttribute(IPluginAttribute attribute) {
