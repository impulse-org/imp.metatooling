...
public class $OUTLINER_CLASS_NAME$ extends DefaultOutliner
{
    ...
    private final class OutlineVisitor extends AbstractVisitor {
		...
		public OutlineVisitor() {
			super();
			fItemStack.push(createTopItem("LEG Program", null));
		}
		...
		public boolean visit(block n) {
			fItemStack.push(createSubItem("Block", n));
			return true;
		}
		...
		public boolean visit(declaration n) {
			createSubItem(n.getidentifier().toString(), n);
			return true;
		}
	
		public boolean visit(assignment n) {
			createSubItem(n.getidentifier().toString() + "=" + n.getexpression().toString(), n);
